...
public class InstagramImages extends ImageView {
	...
	public InstagramImages(Context context) {
		super(context);
	}

	public InstagramImages(Context context, AttributeSet set) {
		super(context, set);
	}

	public InstagramImages(Context context, AttributeSet set, int defStyle) {
